...
export default function Blog({ posts }) {
  ...
  return (
    <main className="container-content mx-auto mt-4 flex flex-col justify-center self-auto align-middle text-slate-300">
      <div className="container-card mb-4 text-slate-50">
